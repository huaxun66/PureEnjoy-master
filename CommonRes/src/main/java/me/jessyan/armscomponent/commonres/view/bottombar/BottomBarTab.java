package me.jessyan.armscomponent.commonres.view.bottombar;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.public_bottom_navigation_unselected));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.public_bottom_navigation_unselected));
        ...
        mTvUnreadCount.setBackgroundResource(R.drawable.public_bg_msg_bubble);
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.public_bottom_navigation_selected));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.public_bottom_navigation_selected));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.public_bottom_navigation_unselected));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.public_bottom_navigation_unselected));
        }
    }
