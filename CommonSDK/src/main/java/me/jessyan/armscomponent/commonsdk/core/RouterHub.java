...
public interface RouterHub {
    ...
    String NEWS = "/news";//新闻组件
    String VIDEO = "/video";//视频组件
    String MUSIC = "/music";//音乐组件
    ...
    String MUSIC_MY_MUSIC_FRAGMENT = MUSIC + "/MusicMyMusicFragment";
    String MUSIC_SONG_SHEET_ACTIVITY = MUSIC + "/MusicSongSheetActivity";
    String MUSIC_HOT_SHEET_ACTIVITY = MUSIC + "/MusicHotSheetActivity";
    String MUSIC_SHEET_TAG_ACTIVITY = MUSIC + "/MusicSheetTagActivity";
    ...
    String MUSIC_LOCAL_SONG_LIST_ACTIVITY = MUSIC + "/MusicLocalSongListActivity";
    String MUSIC_RECENT_PLAY_LIST_ACTIVITY = MUSIC + "/MusicRecentPlayListActivity";
    String MUSIC_SCAN_ACTIVITY = MUSIC + "/MusicScanActivity";
    String MUSIC_PLAY_DETAIL_ACTIVITY = MUSIC + "/MusicPlayDetailActivity";
    String MUSIC_LOCAL_SONG_FRAGMENT = MUSIC + "/MusicLocalSongFragment";
    String MUSIC_LOCAL_SINGER_FRAGMENT = MUSIC + "/MusicLocalSingerFragment";
    String MUSIC_LOCAL_ALBUM_FRAGMENT = MUSIC + "/MusicLocalAlbumFragment";
    String MUSIC_LOCAL_FOLDER_FRAGMENT = MUSIC + "/MusicLocalFolderFragment";
