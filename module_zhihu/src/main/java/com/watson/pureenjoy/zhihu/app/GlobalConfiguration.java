 ...
 */
package com.watson.pureenjoy.zhihu.app;
...
import com.watson.pureenjoy.zhihu.BuildConfig;
 ...
 * CommonSDK 中已有 {@link com.watson.pureenjoy.commonsdk.core.GlobalConfiguration} 配置有所有组件都可公用的配置信息
 * 这里用来配置一些组件自身私有的配置信息
 *
