...
public class LocalMusicInfo implements Comparable, Parcelable {
    ...
    public int compareTo(Object o) {
        LocalMusicInfo info = (LocalMusicInfo)o;
    ...
    public static final Parcelable.Creator<LocalMusicInfo> CREATOR = new Parcelable.Creator<LocalMusicInfo>() {
        @Override
