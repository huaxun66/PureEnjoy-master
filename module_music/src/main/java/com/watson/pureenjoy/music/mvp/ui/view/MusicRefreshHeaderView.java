...
public class MusicRefreshHeaderView extends RelativeLayout implements RefreshHeader {
    ...
    public MusicRefreshHeaderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context);
    }
    public MusicRefreshHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        setGravity(Gravity.CENTER);
        LayoutInflater.from(context).inflate(R.layout.music_refresh_header,this);
